  ...
  return (
    <View style={styles.container}>
      <View style={styles.titleContainer}>
        ...
        <Text style={styles.title}>Histórico de Finanças</Text>
      </View>
      ...
      <View style={styles.pContainerBrown}>
        ...
        <View style={styles.divBrown}>
          <Text style={styles.spanBrown}>Custo A: 150</Text>
          <Text style={styles.spanBrown}>Receita A: 800</Text>
        </View>
        <View style={styles.divBrown}>
          <Text style={styles.spanBrown}>Custo B: 450</Text>
          <Text style={styles.spanBrown}>Receita B: 500</Text>
        </View>
        <View style={styles.divBrown}>
          <Text style={styles.spanBrown}>Custo C: 200</Text>
          <Text style={styles.spanBrown}></Text>
        </View>
        <Text style={styles.spanBrown}>Total mês de janeiro: 500</Text>
      </View>
    </View>
  );
}
