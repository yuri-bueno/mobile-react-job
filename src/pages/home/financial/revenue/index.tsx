    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.boxContainer}>
        <View style={styles.box}>
          ...
          <Text style={styles.boxText}>Nova receita</Text>
        </View>
        <View style={styles.boxShadow}></View>
      </TouchableOpacity>

      <View style={styles.pContainerGreen}>
        <Text style={styles.pGreen}>Receitas anteriores:</Text>
      </View>
      <TouchableOpacity style={styles.pContainerBrown}>
        <Text style={styles.pBrown}>Receita A</Text>
      ...
      <TouchableOpacity style={styles.pContainerBrown}>
        <Text style={styles.pBrown}>Receita B</Text>
        <IconMaterialCommunityIcons
          name="arrow-right-thin"
          size={30}
          style={styles.IconBrown}
