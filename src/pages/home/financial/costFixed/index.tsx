...
export default function CostFixed({
  navigation,
}: {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.titleContainer}>
        ...
        <Text style={styles.title}>Adicionar Custos Fixos</Text>
      </View>
      ...
      <TouchableOpacity style={styles.boxContainer}>
        <View style={styles.box}>
          ...
          <Text style={styles.boxText}>Novo custo fixo</Text>
        </View>
        <View style={styles.boxShadow}></View>
      </TouchableOpacity>

      <View style={styles.pContainerGreen}>
        <Text style={styles.pGreen}>Custos fixos anteriores:</Text>
      </View>
      <TouchableOpacity style={styles.pContainerBrown}>
        <Text style={styles.pBrown}>Custo fixo A</Text>
      ...
      <TouchableOpacity style={styles.pContainerBrown}>
        <Text style={styles.pBrown}>Custo fixo B</Text>
        <IconMaterialCommunityIcons
          name="arrow-right-thin"
          size={30}
          style={styles.IconBrown}
